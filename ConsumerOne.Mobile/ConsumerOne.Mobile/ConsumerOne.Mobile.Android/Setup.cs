...
using ConsumerOne.Mobile.Droid.Services;
...
{
    public class Setup : MvxFormsAndroidSetup<ConsumerOneApp, App>
    {
        ...
        {
            var formsPresenter = new CustomMvxFormsPagePresenter(viewPresenter);
            Mvx.IoCProvider.RegisterSingleton<IMvxFormsPagePresenter>(formsPresenter);
