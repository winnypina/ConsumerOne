...
namespace ConsumerOne.Mobile.Views
{
    ...
    public partial class NewPostPriceView
    {
        public NewPostPriceView()
        {
            InitializeComponent();
        ...
        {
            if (e.PropertyName == "StoreWebsite")
            {
                if (AddressEntry.Text != ViewModel.StoreWebsite)
                {
                    AddressEntry.Text = ViewModel.StoreWebsite;
                }
            }
        }
        ...
        {
            ViewModel.StoreWebsite = ((Entry) sender).Text;
        }
    }
}