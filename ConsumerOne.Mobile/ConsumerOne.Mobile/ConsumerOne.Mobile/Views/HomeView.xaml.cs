...
namespace ConsumerOne.Mobile.Views
{
    ...
    [MvxTabbedPagePresentation(WrapInNavigationPage = true, Icon = "home.png")]
    public partial class HomeView
    {
        public HomeView()
        {
            ...
            Appearing += HomeView_Appearing;
        }

        private void HomeView_Appearing(object sender, System.EventArgs e)
        {
            if(Parent is CustomNavigationPage navPage)
            {
